  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[90vw] sm:max-w-md translate-x-[-50%] translate-y-[-50%] gap-4 border border-slate-200/80 bg-white p-6 shadow-lg duration-200 data-starting-style:translate-y-[-48%] data-starting-style:opacity-0 data-ending-style:translate-y-[-48%] data-ending-style:opacity-0 rounded-xl outline-none",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3 right-3 text-slate-400 hover:text-slate-900"
                size="icon-sm"
              />
            }
          >
