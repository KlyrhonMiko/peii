  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Popover open={deptOpen} onOpenChange={setDeptOpen}>
        ...
        <PopoverContent
          align="end"
          className="w-40 p-1.5 flex flex-col gap-0.5 bg-white border border-slate-200 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] animate-in fade-in-0 zoom-in-95 duration-100"
        >
